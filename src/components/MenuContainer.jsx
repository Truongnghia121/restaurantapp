...
const MenuContainer = () => {
  const [filter, setFilter] = useState("checken");
  ...
  return (
    <section className="w-full p-4 my-6 " id="menu">
      <div className="w-full flex flex-col items-center justify-center">
        ...
        gap-8 mt-6 py-6 overflow-x-scroll scrollbar-none"
        >
          {categories &&
            categories.map((category) => (
              <motion.div
                ...
                rounded-lg drop-shadow-xl hover:bg-cartNumBg flex flex-col gap-3 items-center justify-center`}
