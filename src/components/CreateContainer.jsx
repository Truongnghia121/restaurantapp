...
const CreateContainer = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
      <div
        className="w-[90%] md:w-[75%] border border-gray-200 
      ...
      >
        ...
        <div className="w-full">
          <select
            ...
            className="
          outline-none w-full text-base border-b-2 border-gray-200 rounded-md
          cursor-pointer"
          >
        ...
        <div
          className="group flex justify-center items-center flex-col 
              border-2 border-dotted border-gray-300 w-full h-225 md:h420 
        ...
        <div className="flex items-center w-full">
          <button
            type="button"
            className="ml-0 md:ml-auto md:w-auto w-full
