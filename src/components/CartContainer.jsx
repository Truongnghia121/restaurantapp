...
const CartContainer = () => {
  return (
    <div
      className="w-full fixed top-0 right-0 md:w-375 h-screen bg-white drop-shadow-md 
  flex flex-col z-[101]"
    >
      ...
      <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
        {/* cart item section */}
        <div
          className="w-full h-340 md:h-42 px-6 py-8 flex flex-col gap-3 overflow-y-scroll 
        scrollbar-none"
        >
          {/* cart item */}
          <div className="w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/restaurantapp-b3094.appspot.com/o/Images%2F1660553629592-i6.png?alt=media&token=9cd6d342-8b99-4ccd-a10d-b76f908572f6"
              alt=""
        ...
        >
          ...
          <motion.button
            whileTap={{ scale: 0.8 }}
            type="button"
            className="w-full p-2 rounded-full bg-yellow-600 text-gray-50 text-lg 
